...
-- AddForeignKey
ALTER TABLE "ClientFollowUp" ADD CONSTRAINT "ClientFollowUp_assignedToId_fkey" FOREIGN KEY ("assignedToId") REFERENCES "Personnel"("id") ON DELETE SET NULL ON UPDATE CASCADE;
