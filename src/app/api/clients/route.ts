...
export async function POST(request: Request) {
  ...
  try {
    ...
    const newClient = await prisma.client.create({
      data: { name, contactName, contactPhone: contactPhone?.trim() || null, locationAddress, paymentTerms },
    });
...
// PUT: Edit a client's name, contact details, address, or payment terms.
